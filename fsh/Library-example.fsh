...
* relatedArtifact[0].citation = "Pani, D., Sulas, E., Urru, M., Sameni, R., Raffo, L., & Tumbarello, R. (2020). NInFEA: Non-Invasive Multimodal Foetal ECG-Doppler Dataset for Antenatal Cardiology Research (version 1.0.0)."
* relatedArtifact[0].url = "https://doi.org/10.13026/c4n5-3b04"
