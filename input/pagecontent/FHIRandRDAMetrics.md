...
<p>A pragmatic approach is therefore suggested in the evaluation of this requirement,  determining case by case, and in dependence of the type of data (study level or subject level data), what are the actual information to label as metadata, that should and can be distinguished by the associated data. Assuming that other information, that could be considered as well as metadata might be recorded in the same object , recording the data.</p></td>
</tr>
<tr style="border: 1px solid gray; ">
<td>RDA-F1-01D</td>
